    ...
    <div className="wrapper info">
      <div className="content-wrapper">
        <div
          ...
          onClick={() => changeContent("simplicity")}
        >
        ...
        <div
          className="content-section"
          onClick={() => changeContent("accessibility")}
        >
        ...
        <div
          className="content-section"
          onClick={() => changeContent("performance")}
        >
        ...
        <div
          className="content-section"
          onClick={() => changeContent("innovation")}
        >
